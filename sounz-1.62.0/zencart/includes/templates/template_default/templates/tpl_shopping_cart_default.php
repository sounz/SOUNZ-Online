...
<span id="cartProdTitle"><?php echo $product['productsName'] . '<span class="alert bold">' . $product['flagStockCheck'] . '</span>'; ?>
 <?if (($product['weight']=='9999') || (($special_library_order == true) && (preg_match('/^LOAN/', $product['productsClass']) > 0))) {echo "<font color=\"#f00\"><b>Special Order Only!</b></font>";}?>
</span>
<br class="clearBoth" />
...
<?php 
  if (isset($_SESSION['customer_id']) && $_SESSION['customer_id']) {
    ...
    echo '<div class="buttonRow forward"><a href="http://'.SOUNZ_SERVER.'/people/login_from_checkout">' . zen_image_button(BUTTON_IMAGE_CHECKOUT, BUTTON_CHECKOUT_ALT) . '</a></div>';
  }
?>

...
if ($payment_modules->selected_module == 'dpsaccess')
{
#just draw the button
if (is_array($payment_modules->modules)) {
    echo '<div class="buttonRow forward">';
	echo $payment_modules->process_button();
	echo '<image src="includes/templates/template_default/buttons/english/button_confirm_order.gif" alt="Confirm Order" title=" Confirm Order "/></div>';
	echo '</a>';
  }
}
else

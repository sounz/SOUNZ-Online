...
if (!isset($_SESSION['customers_ip_address'])) {
 ...
 /**Update our dps data if we are in test mode (DEPRECATED)
 if (SOUNZ_TEST_MODE =='true')
 	{
	$db->Execute("update ". TABLE_CONFIGURATION . " set configuration_value='SOUNZ_dev' where configuration_key='MODULE_PAYMENT_DPSACCESS_USERID';");
	$db->Execute("update ". TABLE_CONFIGURATION . " set configuration_value='0e33b0f5bc5cd948ced947f37b5c0d8a9a021d9b26989dfb' where configuration_key='MODULE_PAYMENT_DPSACCESS_DESKEY';");
	$db->Execute("update ". TABLE_CONFIGURATION . " set configuration_value='fa6b4bb6cf092d8b' where configuration_key='MODULE_PAYMENT_DPSACCESS_MACKEY';");
	}
*/
?>
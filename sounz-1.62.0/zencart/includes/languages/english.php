...
// javascript messages
  ...
  define('ENTRY_COMPANY', 'Organisation:');
  ...
  define('ENTRY_STREET_ADDRESS', 'Street/PO Box:');
  define('ENTRY_STREET_ADDRESS_ERROR', 'Your Street must contain a minimum of ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' characters.');
  ...
  define('ENTRY_CITY', 'Locality:');
  define('ENTRY_CUSTOMERS_REFERRAL', 'Referral Code:');

  define('ENTRY_CITY_ERROR', 'Your Locality must contain a minimum of ' . ENTRY_CITY_MIN_LENGTH . ' characters.');
...
// downloads module defines
  ...
  define('DOWNLOAD_PREAMBLE','');
  define('DOWNLOAD_POSTSCRIPT','');
  define('HEADING_DOWNLOAD', 'To download the files you have purchased, click the \'Download\' button and select \'Save to Disk\' from the popup menu.');

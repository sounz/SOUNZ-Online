...
<?php  
    ...
    define('MODULE_PAYMENT_DPS_PXPAY_TEXT_TITLE', MODULE_PAYMENT_DPS_PXPAY_TEXT_TITLE);
    ...
    // logo and message
    define('MODULE_PAYMENT_DPS_PXPAY_LOGO', '<br><a href="http://www.paymentexpress.co.nz/" target="_blank"><img src="images/dps_logo.gif" alt="DPS" border="0"></a>');

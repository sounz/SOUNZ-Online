...
// on address form
// begin
$address = zen_get_customer_address($_SESSION['customer_id'], $_SESSION['billto']);
...
if (!$address['street_address'] || !$address['city'] || !$address['country_id']) {
  ...
  if (isset($_SESSION['billto']) && empty($_SESSION['billto']))  zen_redirect(zen_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS));
  else $address = zen_get_customer_address($_SESSION['customer_id'], $_SESSION['billto']);
}

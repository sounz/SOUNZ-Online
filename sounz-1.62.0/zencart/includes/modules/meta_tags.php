...
switch ($_GET['main_page']) {
  ...
  */
  ...
  $sql= "select pd.products_name, p.products_model, p.products_price_sorter, p.products_tax_class_id,
                              ...
                              from " . TABLE_PRODUCTS_DESCRIPTION . " pd left join " . TABLE_PRODUCTS . " p on p.products_id=pd.products_id left join " . TABLE_META_TAGS_PRODUCTS_DESCRIPTION . " mtpd on mtpd.products_id = p.products_id and mtpd.language_id = '" . (int)$_SESSION['languages_id'] . "'

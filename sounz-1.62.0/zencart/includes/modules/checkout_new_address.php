...
//echo ' I SEE: country=' . $country . '&nbsp;&nbsp;&nbsp;state=' . $state . '&nbsp;&nbsp;&nbsp;zone_id=' . $zone_id;
    ...
    if ($error == false) {
      ...
      $db->perform(ZENCART_TABLE_ADDRESS_BOOK, $sql_data_array);
      switch($addressType) {
        case 'billto':
        $_SESSION['billto'] = $db->Insert_ID(TABLE_ADDRESS_BOOK_SEQ);
        $_SESSION['payment'] = '';
        zen_redirect(zen_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL'));
        break;
        case 'shipto':
        $_SESSION['sendto'] = $db->Insert_ID(TABLE_ADDRESS_BOOK_SEQ);
        $_SESSION['shipping'] = '';

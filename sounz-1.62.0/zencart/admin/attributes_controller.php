...
// @TODO: MySQL5
            ...
            if (DOWNLOAD_ENABLED == 'true') {
              $products_attributes_id = $db->Insert_ID(TABLE_PRODUCTS_ATTRIBUTES_SEQ);
...
// turned off until working
          $db->Execute("update " . TABLE_PRODUCTS_ATTRIBUTES . "
            ...
            if (DOWNLOAD_ENABLED == 'true') {
              ...
              if (zen_not_null($products_attributes_filename)) {
				if ($products_attributes_maxdays==''){$products_attributes_maxdays=0;}
				if ($products_attributes_maxcount==''){$products_attributes_maxcount=0;}
                $db->Execute("update " . TABLE_PRODUCTS_ATTRIBUTES_DOWNLOAD . " set 
...
// fix limit error on some versions
  ...
  $attributes = $attributes . " LIMIT $per_page OFFSET $attribute_page_start";

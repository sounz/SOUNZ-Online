...
// Define the webserver and path parameters
  ...
  #not used in admin currently, but just in case...
...
// * DIR_FS_* = Filesystem directories (local/physical)
  ...
  define('DIR_FS_ADMIN', '/data/sounz/htdocs/zencart/admin/');
  ...
  // NOTE: Since only Catalyst has access to zencart admin UI,
  // we set it to true in admin configurations for debugging purposes
  define('DB_ERROR_REPORTING', 'true');

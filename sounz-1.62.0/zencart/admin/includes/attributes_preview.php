...
// iii 030813 added: initialize $number_of_uploads
      ...
      if ( PRODUCTS_OPTIONS_SORT_BY_PRICE =='1' ) {
        $order_by= ' order by  pov.products_options_values_name';
      } else {
        $order_by= ' order by  pa.options_values_price';
      }
...
//                  if ((preg_replace('/txt_/', '', $key) == $products_options_names->fields['products_options_id'] and $value == $products_options->fields['products_options_values_id'])) {

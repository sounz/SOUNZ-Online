...
//      $search = "where c.customers_lastname like '%" . $keywords . "%' or c.customers_firstname like '%" . $keywords . "%' or c.customers_email_address like '%" . $keywords . "%'";
      $search = "where c.customers_lastname like '%" . $keywords . "%' or c.customers_firstname like '%" . $keywords . "%' or c.customers_email_address like '%" . $keywords . "%' or c.customers_telephone ~ '" . $keywords . "' or a.entry_company ~ '" . $keywords . "' or a.entry_street_address ~ '" . $keywords . "' or a.entry_city ~ '" . $keywords . "' or a.entry_postcode ~ '" . $keywords . "'";
    }

...
function TinyMCE_Engine() {
	...
	this.isGecko36 = (this.isGecko && ua.indexOf('irefox/3.6.')!= -1 && parseInt(ua.substr(ua.indexOf('irefox/3.6.')+11,2)) >= 9 );
	this.isGecko36 = (this.isGecko36 || (this.isGecko && ua.indexOf('irefox/3.5.')!= -1 && parseInt(ua.substr(ua.indexOf('irefox/3.5.')+11,2)) >= 9 ) );
...
/*			if (elm == inst.lastTriggerEl)
	...
	*/
	...
	fixGeckoBaseHREFBug : function(m, e, h) {
		...
		if (tinyMCE.isGecko && !tinyMCE.isGecko36) {
			if (m == 1) {

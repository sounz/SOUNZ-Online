...
namespace :solr do
  ...
  desc 'Starts Solr. Specify the environment by using: RAILS_ENV=test|development|production. Defaults to development if none.'
  task :start do
  ...
  desc 'Stops Solr. Specify the environment by using: RAILS_ENV=test|development|production. Defaults to development if none.'
  task :stop do
    fork do

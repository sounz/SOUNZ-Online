...
// * DIR_FS_* = Filesystem directories (local/physical)
  ...
  define('DIR_FS_ADMIN', '_APACHE_DOCUMENTROOT_/zencart/admin/');
  define('DIR_FS_CATALOG', '_APACHE_DOCUMENTROOT_/zencart/');
...
// define our database connection
  ...
  define('DIR_FS_SQL_CACHE', '_APACHE_DOCUMENTROOT_/zencart/cache');

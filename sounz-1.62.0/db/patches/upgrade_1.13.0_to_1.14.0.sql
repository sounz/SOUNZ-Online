...
-- delete inactive borrowed items records (it was testing)
update items set out_on_loan_or_hire = 'f' where item_id in (select item_id from borrowed_items where active='f');

delete from borrowed_items where active = 'f'; 

-- WR#42857 - delete 'Not-applicable' type from resource types
delete from resource_type_formats where resource_type_id = (select resource_type_id from resource_types where resource_type_desc = 'Not-applicable');

delete from resource_types where resource_type_desc = 'Not-applicable';

-- WR#52091 - the final version of 'Not-applicable' manifestation formats
delete from manifestation_type_formats where manifestation_type_id = 
(select manifestation_type_id from manifestation_types where manifestation_type_desc = 'Not-applicable');

insert into manifestation_type_formats (manifestation_type_id, format_id)
  values ((select manifestation_type_id from manifestation_types where manifestation_type_desc = 'Not-applicable'),
          (select format_id from formats where format_desc = 'CD'));

insert into manifestation_type_formats (manifestation_type_id, format_id)
  values ((select manifestation_type_id from manifestation_types where manifestation_type_desc = 'Not-applicable'),
          (select format_id from formats where format_desc = 'DVD'));

insert into manifestation_type_formats (manifestation_type_id, format_id)
  values ((select manifestation_type_id from manifestation_types where manifestation_type_desc = 'Not-applicable'),
          (select format_id from formats where format_desc = 'digital sound file - MP3'));

insert into manifestation_type_formats (manifestation_type_id, format_id)
  values ((select manifestation_type_id from manifestation_types where manifestation_type_desc = 'Not-applicable'),
          (select format_id from formats where format_desc = 'digital sound file - bwf'));

insert into manifestation_type_formats (manifestation_type_id, format_id)
  values ((select manifestation_type_id from manifestation_types where manifestation_type_desc = 'Not-applicable'),
          (select format_id from formats where format_desc = 'digital sound file - wav'));

insert into manifestation_type_formats (manifestation_type_id, format_id)
  values ((select manifestation_type_id from manifestation_types where manifestation_type_desc = 'Not-applicable'),
          (select format_id from formats where format_desc = 'digital movie'));

insert into manifestation_type_formats (manifestation_type_id, format_id)
  values ((select manifestation_type_id from manifestation_types where manifestation_type_desc = 'Not-applicable'),
          (select format_id from formats where format_desc = 'Mini DV'));

insert into manifestation_type_formats (manifestation_type_id, format_id)
  values ((select manifestation_type_id from manifestation_types where manifestation_type_desc = 'Not-applicable'),
          (select format_id from formats where format_desc = 'cassette'));

insert into manifestation_type_formats (manifestation_type_id, format_id)
  values ((select manifestation_type_id from manifestation_types where manifestation_type_desc = 'Not-applicable'),
          (select format_id from formats where format_desc = 'vinyl (LP or EP)'));

insert into manifestation_type_formats (manifestation_type_id, format_id)
  values ((select manifestation_type_id from manifestation_types where manifestation_type_desc = 'Not-applicable'),
          (select format_id from formats where format_desc = 'DAT'));

insert into manifestation_type_formats (manifestation_type_id, format_id)
  values ((select manifestation_type_id from manifestation_types where manifestation_type_desc = 'Not-applicable'),
          (select format_id from formats where format_desc = 'video'));
                   
-- memberships
alter table memberships add column sounz_service_id INT4;

-- CREATING NEW CONSTRAINT fk_membership_sounz_service
alter table memberships
  add constraint fk_membership_sounz_service foreign key (sounz_service_id) references sounz_services (sounz_service_id) on update restrict on delete restrict deferrable initially deferred;

-- CREATING NEW INDEX membership_sounz_service_fk
create index membership_sounz_service_fk on memberships using btree (sounz_service_id);

-- settings
insert into settings (setting_name, setting_value) 
 values ('ExpiringMembershipsNotificationRecipient', 'development@sounz.org.nz');

insert into settings (setting_name, setting_value) 
  values ('ExpiringMembershipsFailureRecipient', 'liuba@catalyst.net.nz,paul@catalyst.net.nz');

insert into settings (setting_name, setting_value) 
  values ('ExpiringMembershipsDayFromNowFrom', '21');

insert into settings (setting_name, setting_value) 
  values ('ExpiringMembershipsDayFromNowTo', '28');

-- WR#50826 fix for sounz_service_name
update sounz_services set sounz_service_name = 'SOUNZ Online Membership (3 months)' 
    where sounz_service_name = 'Sounz Online Membership (3 months)';

update sounz_services set sounz_service_name = 'SOUNZ Online Membership (12 months)' 
    where sounz_service_name = 'Sounz Online Membership (12 months)';
    
update sounz_services set sounz_service_name = 'SOUNZ Supersize Library Membership' 
    where sounz_service_name = 'Sounz Supersize Library Membership';

update sounz_services set sounz_service_name = 'SOUNZ Standard Library Membership' 
    where sounz_service_name = 'Sounz Standard Library Membership';

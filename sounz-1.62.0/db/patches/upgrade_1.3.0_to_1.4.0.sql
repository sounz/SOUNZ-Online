-- Remove work categories
begin;

delete from work_categorizations where work_subcategory_id in
 (select work_subcategory_id from work_subcategories where additional = false);
...
-- Adding 'PDF' attachment type
insert into attachment_types (attachment_type_desc, display_order) values ('Pdf', 5);
